...
print("\n==== Testing and Verification with Batched Data (Single Tensor) ====")
...
# Test with different batch sizes, sequence lengths, and channel dimensions using tuples
print("\n==== Testing and Verification with Batched Data (Tuple of Tensors) ====")

for batch, length, channels in test_configs:
    print(f"\n=== Testing batch={batch}, seq_len={length}, channels={channels} (with tuples) ===")
    verify_scan_batched(batch, length, channels, operator.add, device=device, use_tuple=True)

# Benchmark with different configurations
print("\n==== Performance Benchmarks with Batched Data (Single Tensor) ====")
...
# Benchmark with different configurations using tuples
print("\n==== Performance Benchmarks with Batched Data (Tuple of Tensors) ====")

for batch, length, channels in benchmark_configs:
    print(f"\n--- Benchmarking batch={batch}, seq_len={length}, channels={channels} (with tuples) ---")
    
    for op, name in operators:
        print(f"\nOperator: {name}")
        benchmark_scan_batched(batch, length, channels, op, None, device=device, use_tuple=True)